...
namespace Vendor.Datalayer.Migrations
{
    ...
    [Migration("20200925085911_ChangeTypeOfRandD")]
    partial class ChangeTypeOfRandD
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vendor.Domain.Entites.Cars.Car", b =>
                {
                    ...
                    b.Property<decimal>("ManufactuCapacityreDate")
                        .HasColumnType("decimal(18,2)");

                    b.Property<DateTime>("ManufactureDate")
                        .HasColumnType("datetime2");

                    b.Property<string>("UploadQc")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Vendor.Domain.Entites.Companies.Company", b =>
                {
                    ...
                    b.Property<string>("ResearchMember")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Vendor.Domain.Entities.ExportProducts.ExportProduct", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Vendor.Domain.Entities.ProductCompanies.ProductCompany", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Vendor.Domain.Entites.Companies.Company", b =>
                {
                    b.HasOne("Vendor.Domain.Entites.Cars.Car", "Car")
                        .WithMany("Companies")
                        .HasForeignKey("CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("Vendor.Domain.Entites.Products.Product", null)
                        .WithMany("Companies")
            ...
            modelBuilder.Entity("Vendor.Domain.Entities.ExportProducts.ExportProduct", b =>
                {
                    b.HasOne("Vendor.Domain.Entites.Exports.Export", "Export")
