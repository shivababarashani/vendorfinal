...
namespace Vendor.Datalayer.Migrations
{
    ...
    [Migration("20201021082010_ContractTypesEnum")]
    partial class ContractTypesEnum
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vendor.Domain.Entites.Cars.Car", b =>
                {
                    ...
                    b.Property<string>("UploadCalibrationMachine")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Vendor.Domain.Entites.Companies.Company", b =>
                {
                    ...
                    b.Property<long>("ManufacturingGroupId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ManufacturingGroupId");
            ...
            modelBuilder.Entity("Vendor.Domain.Entites.Companies.ManufacturingGroup", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Vendor.Domain.Entites.Contracts.Contract", b =>
                {
                    ...
                    b.Property<long?>("ContractTypeId1")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Vendor.Domain.Entites.Companies.Company", b =>
                {
                    ...
                    b.HasOne("Vendor.Domain.Entites.Companies.ManufacturingGroup", "ManufacturingGroup")
                        .WithMany("Companies")
                        .HasForeignKey("ManufacturingGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Vendor.Domain.Entites.Contracts.Contract", b =>
                {
                    b.HasOne("Vendor.Domain.Entites.Contracts.ContractType", null)
                        .WithMany("Contracts")
